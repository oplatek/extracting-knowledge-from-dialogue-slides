...
\begin{frame}\frametitle{Easy first decoding for dialogue state tracking}
    ...
    \begin{itemize}
        ...
        \item Further insight in DST2 data 
    \end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Predicting misunderstanding}
    Collect followup conversation after artificial introduced misunderstanding \\
    Predicting misunderstanding from the followup conversations \\
    TODO
\end{frame}

\begin{frame}\frametitle{Data and label augmentation}
    TODO
\end{frame}

\section{Summary}

\begin{frame}\frametitle{Motivation and current state}
    TODO
\end{frame}
